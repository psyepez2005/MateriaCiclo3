...
val sumEdades: Double = listaEst.map(_.edad).sum

val sumPesos: Double = listaEst.map(_.peso).sum

val promEdades: Double = listaEst.map(_.edad).sum/listaEst.size

val promPesos: Double = listaEst.map(_.peso).sum/listaEst.size


val mayoresEDAD: Double = listaEst.count(_.edad>promEdades)//listaEst.map(_.edad>promEdades)

val menoresEDAD: Double = listaEst.map(_.edad<promEdades)

val mayoresPESO: Double = listaEst.map(_.peso>promEdades)

val menoresPESO: Double = listaEst.map(_.peso<promEdades)
